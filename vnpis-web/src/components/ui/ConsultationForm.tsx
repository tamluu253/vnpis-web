              ...
              <div className="bg-slate-100 p-4 rounded-2xl border border-slate-200 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a
                    ...
                    className="flex items-center justify-center space-x-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 rounded-xl text-xs transition-colors shadow-sm"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center space-x-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2.5 px-4 rounded-xl text-xs transition-colors shadow-sm"
                  >
