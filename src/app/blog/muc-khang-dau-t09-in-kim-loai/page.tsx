...
export const metadata = {
  title: 'Mực Kháng Dầu T09: Cứu Tinh Cho Gia Công Cơ Khí | VNPIS',
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <article className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-slate-100 mb-12">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <span className="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">Mã: T09</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">Mực Kháng Dầu T09: Cứu Tinh Cho Gia Công Cơ Khí</h1>
          <p className="text-xl text-slate-600 mb-10 leading-relaxed">Các chi tiết kim loại phay tiện xong thường dính lớp dầu bảo quản. Mực T09 có khả năng tự xuyên qua lớp dầu mỏng để bám chặt vào kim loại.</p>
          
          <div className="mb-12">
            <img src="/media/blog/muc-khang-dau-t09-in-kim-loai.jpg" alt="Mực Kháng Dầu T09: Cứu Tinh Cho Gia Công Cơ Khí" className="w-full h-auto rounded-xl shadow-lg border border-slate-200" />
          </div>

          <div className="prose prose-lg max-w-none text-slate-700">
            <h2>Tại sao nên sử dụng mã mực T09?</h2>
            <p>Trong môi trường sản xuất công nghiệp, việc chọn đúng loại mực quyết định tới 80% khả năng truy xuất nguồn gốc và nhận diện thương hiệu. Dòng mực CIJ mã <strong>T09</strong> của VNPIS mang lại hiệu suất vượt trội, loại bỏ hoàn toàn các vấn đề bong tróc, mờ nhòe hay nghẹt đầu in.</p>
        ...
        <div className="bg-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl text-white">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">Cần Tư Vấn & Báo Giá Mã T09?</h2>
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea rows={3} className="w-full px-4 py-3 rounded-lg border border-slate-700 bg-slate-800 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" defaultValue={"Tôi quan tâm đến mã mực T09. Vui lòng liên hệ tư vấn."}></textarea>
            </div>
